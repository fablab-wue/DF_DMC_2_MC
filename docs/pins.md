...
![DF_DMC_2_MC RP2040-Zero pinout](img/pinout.png)
...
Handshake: DMC sends `VH` then `CG` (same as UIC `MC_Client`). Details: [link-and-handshake.md](https://github.com/fablab-wue/SliderDoc/blob/main/contract/link-and-handshake.md). MC pin maps: [mc/pins.md](https://github.com/fablab-wue/SliderDoc/blob/main/mc/pins.md).
...
Isolated dry-contact shutter cables: use a **PC817** instead — [components/camera.md](https://github.com/fablab-wue/SliderDoc/blob/main/components/camera.md) and [mc/pins.md](https://github.com/fablab-wue/SliderDoc/blob/main/mc/pins.md#pin_camera_ctrl-low-active-open-collector).
...
MC buzzer pin: Pico GP28 / Zero GP28 (`PIN_BUZZER`, `BUZZER_use`). See [mc/pins.md](https://github.com/fablab-wue/SliderDoc/blob/main/mc/pins.md).
