...
Framing, the path upload table, DMX transmit, and GIO live in [DF_DMC_Common](https://github.com/fablab-wue/DF_DMC_Common). This firmware keeps the SliderMC UART, `PD` packing, and the NeoPixel.

Shared Connect steps: [DF_DMC_Common — Dragonframe](https://github.com/fablab-wue/DF_DMC_Common/blob/main/docs/dragonframe.md).
