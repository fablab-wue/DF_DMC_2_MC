...
Clone [DF_DMC_Common](https://github.com/fablab-wue/DF_DMC_Common) next to this repo (`../DF_DMC_Common`). `platformio.ini` depends on it with `symlink://../DF_DMC_Common` and `-DFDMC_MAX_AXES=6`.

SliderMC build notes (WinUSB / picotool) also apply: [mc/build.md](https://github.com/fablab-wue/SliderDoc/blob/main/mc/build.md#windows-upload-picotool--upload_port-error).
